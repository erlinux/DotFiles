...
#   Author: Teddysun <i@itxdm.me>                             #
#   Thanks: @clowwindy <https://twitter.com/clowwindy>            #
#   Intro:  https://itxdm.me/342.html                         #
#=================================================================#
...
echo "# Intro: https://itxdm.me/342.html                      #"
echo "# Author: Teddysun <i@itxdm.me>                         #"
...
pre_install(){
    ...
    read -p "(Default password: itxdm.me):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="itxdm.me"
    echo
    echo "---------------------------"
...
install_ss(){
    ...
    if [ -f /usr/bin/ssserver ] || [ -f /usr/local/bin/ssserver ]; then
        ...
        echo
        echo "Shadowsocks install failed! please visit https://itxdm.me/342.html and contact."
        install_cleanup
        exit 1
    fi
    clear
    ...
    echo
    echo "Welcome to visit:https://itxdm.me/342.html"
    echo "Enjoy it!"
    echo
}
